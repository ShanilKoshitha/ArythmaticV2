                     ...
                     <div className="col-xl-2 col-lg-2 col-md-4 col-4">
                        <div className="header-main-left">
                           <div className="header-logo header1-logo">
                              <Link href="/"><a className="logo-bb"><img src="assets/img/logo/arythmatic-white.png" alt="logo-img" /></a></Link>
                              <Link href="/"><a className="logo-bw"><img src="assets/img/logo/arythmatic-dark.png" alt="logo-img" /></a></Link>
                           </div>
                        </div>
                     </div>
